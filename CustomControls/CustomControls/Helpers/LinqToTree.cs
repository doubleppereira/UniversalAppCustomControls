...
namespace CustomControls
{
    ...
    public static class TreeExtensions
    {
        ...
        /// <summary>
        /// Returns the next sibling in the visual tree.
        /// </summary>
        public static DependencyObject GetNextSiblingInVisualTree(this DependencyObject origin)
        {
    ...
    public static class EnumerableTreeExtensions
    {
        ...
        public static T FindChildByName<T>(this DependencyObject item, string childName)
            where T : DependencyObject
        {
            if (item == null)
            {
